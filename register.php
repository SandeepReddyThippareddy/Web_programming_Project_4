...
<body>
	...
	<div id="page-wrapper" style="color: black;">
		<div class="row">
								...
								<div class="loginbox">
									<div class="login-right">
										<div class="login-right-wrap">
											<h1 class="account-subtitle">Register</h1>
											...
											<form method="post" enctype="multipart/form-data">
												...
												<button class="btn btn-warning" name="reg" value="Register" type="submit">Register</button>
			...
			<a href="#" class="bg-secondary text-white hover-text-secondary" id="scroll"></a>
		</div>
	</div>
