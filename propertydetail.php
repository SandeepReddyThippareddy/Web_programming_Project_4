                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <span class="mb-sm-20 d-block text-capitalize"> &nbsp;<?php echo $row['14'];?></span>
							</div>
                            <div class="col-md-6">
                        ...
                        <div class="property-details">
                            ...
                            <h5 class="mt-5 mb-4 double-down-line-left position-relative">Contact Agent</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-4">
                                        <button type="submit" class="btn btn-warning w-100">Search Property</button>
                                    </div>
                                </div>
                            </div>
                        </form> 
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
                                ...
                                <li> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                    ...
                                    <span class="font-14"> <?php echo $row['14'];?></span>
